...
return (
  <div className={s.container}>
    ...
    <div className={s.dateWrapper}>
        ...
        <button  type="button" onClick={handlePreviousPeriod} className={`${s.buttonPeriod} ${s.buttonLeft}`}>
    ...
    <button  type="button" onClick={handleNextPeriod} className={`${s.buttonPeriod} ${s.buttonRight}`}>
